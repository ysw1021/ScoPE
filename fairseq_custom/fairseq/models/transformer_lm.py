...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    full_context_alignment: Optional[bool] = field(
        default=False,
        metadata={"help": "Full context alignment"},
    )
...
@register_model_architecture("transformer_lm", "transformer_lm_test")
def transformer_lm_test(args):
    args.decoder_layers = safe_getattr(args, "decoder_layers", 1)
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 8)
    args.decoder_ffn_embed_dim = safe_getattr(args, "decoder_ffn_embed_dim", 16)
    args.decoder_attention_heads = safe_getattr(args, "decoder_attention_heads", 1)
    args.full_context_alignment = safe_getattr(args, "full_context_alignment", True)
    base_lm_architecture(args)


@register_model_architecture("transformer_lm", "ebpe_editor")
def transformer_lm_ebpe(args):
    args.decoder_layers = safe_getattr(args, "decoder_layers", 6)
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 512)
    args.decoder_ffn_embed_dim = safe_getattr(args, "decoder_ffn_embed_dim", 2048)
    args.decoder_attention_heads = safe_getattr(args, "decoder_attention_heads", 8)
...
@register_model_architecture("transformer_lm", "ebpe_editor_small")
def transformer_lm_ebpe(args):
    args.decoder_layers = safe_getattr(args, "decoder_layers", 1)
...
@register_model_architecture("transformer_lm", "ebpe_editor_big")
def transformer_lm_ebpe(args):
    args.decoder_layers = safe_getattr(args, "decoder_layers", 12)
