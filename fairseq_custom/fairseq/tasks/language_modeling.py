...
class LanguageModelingConfig(FairseqDataclass):
    ...
    # ysw added 221218
    gpt_mode: bool = field(default=False, metadata={"help": "0: default mode,"
                                                       " 1: gpt style editor mode,"
                                                       " 2: roberta style editor mode"})
...
class LanguageModelingTask(LegacyFairseqTask):
    ...
    def setup_dictionary(cls, args, **kwargs):
        ...
        if args.data:
            ...
            assert len(paths) > 0
            dictionary = Dictionary.load(os.path.join(paths[0], "dict.txt"), args.gpt_mode)
